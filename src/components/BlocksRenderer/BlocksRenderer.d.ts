...
declare const ComponentsProvider: ({ children, value }: ComponentsProviderProps) => import("react/jsx-runtime").JSX.Element;
...
declare const BlocksRenderer: (props: BlocksRendererProps) => import("react/jsx-runtime").JSX.Element;
